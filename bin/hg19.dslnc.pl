...
$mk2 .= "\t$conf{BIN}/stringtie --merge -G $conf{GTF} -o $out/2.identification/abinit.merged.gtf -l SK $out/1.standard/gtf.lst && touch 00stringtie.finished\n";
$all2 .= "00stringtie.finished ";

#$mk .= "01linkbam.finished: 01align.finished\n";
$mk2 .= "00getchr.finished: 00stringtie.finished\n";
$mk2 .= "\tperl $conf{BIN}/fishInWinter.pl $conf{Chr} $out/2.identification/abinit.merged.gtf > $out/2.identification/abinit.merged.cl.gtf && touch 00getchr.finished\n";
$all2 .= "00getchr.finished ";

$mk2 .= "00changebed.finished: 00getchr.finished\n";
$mk2 .= "\tperl $conf{BIN}/gtf_to_bed.pl $out/2.identification/abinit.merged.cl.gtf > $out/2.identification/abinit.merged.cl.bed && touch 00changebed.finished\n";
$all2 .= "00changebed.finished ";


$mk2 .= "00rmknown.finished: 00changebed.finished\n";
$mk2 .= "\t$conf{Bedtools} intersect -a $out/2.identification/abinit.merged.cl.bed -b $conf{GTF} -v -s -f 0.1 | egrep -v \"NM|NR\" > $out/2.identification/abinit.merged.cl.novo.bed && touch 00rmknown.finished\n";
$all2 .= "00rmknown.finished ";

$mk2 .= "00changegtf.finished: 00rmknown.finished\n";
$mk2 .= "\tperl $conf{BIN}/get_gtf8bed.pl $out/2.identification/abinit.merged.cl.novo.bed $out/2.identification/abinit.merged.cl.gtf > $out/2.identification/abinit.merged.cl.novo.gtf && touch 00changegtf.finished\n";
...
$mk2 .= "\tperl $conf{BIN}/codingpotential_filter.pl $out/2.identification/abinit.iseerna.novo.out/abinit.merged.cl.novo.result > $out/2.identification/abinit.iseerna.novo.out/abinit.merged.cl.novo.result.0.8.filtered && touch 01getnovel.finished\n";
$all2 .= "01getnovel.finished ";

$mk2 .= "01getnovelgtf.finished: 01getnovel.finished\n";
$mk2 .= "\tperl $conf{BIN}/new_get_gtf8bed.pl $out/2.identification/abinit.iseerna.novo.out/abinit.merged.cl.novo.result.0.8.filtered $out/2.identification/abinit.merged.cl.gtf > $out/2.identification/abinit.new.gtf && touch 01getnovelgtf.finished\n";
$all2 .= "01getnovelgtf.finished ";

#接着这里
$mk2 .= "02changebed.finished: 01getnovelgtf.finished\n";
$mk2 .= "\tcd ..\n";
$mk2 .= "\tperl $conf{BIN}/generate_final_gtf.pl $out/2.identification/abinit.new.gtf > $out/2.identification/novo.trans.gtf 2> $out/2.identification/novo.trans.bed  && touch 02changebed.finished\n";
$all2 .= "02changebed.finished ";

$mk2 .= "02rmIntergeniclnc.finished: 02changebed.finished\n";
$mk2 .= "\t$conf{Bedtools} intersect -a $out/2.identification/novo.trans.bed -b ../data/refGene.bed -v > $out/2.identification/novo.trans.non-ol.bed && touch 02rmIntergeniclnc.finished \n";
$all2 .= "02rmIntergeniclnc.finished ";

$mk2 .= "02getgtf.finished: 02rmIntergeniclnc.finished\n";
$mk2 .= "\tperl $conf{BIN}/get_gtf8bed.pl $out/2.identification/novo.trans.non-ol.bed $out/2.identification/abinit.new.gtf > $out/2.identification/novo.trans.non-ol.gtf && touch 02getgtf.finished\n";
...
$mk2 .= "\tless ../data/refGene.anno | grep lncRNA |cut -f 3 | sed \'s\/,\/\\n\/g\' | sort | uniq > $out/2.identification/lncRNA.trans.lst && touch 02getknownlnc.finished\n";
$all2 .= "02getknownlnc.finished ";

$mk2 .= "02getknownlncgtf.finished: 02getknownlnc.finished\n";
$mk2 .= "\tperl $conf{BIN}/get_known_lncrna.pl $out/2.identification/lncRNA.trans.lst $out/2.identification/all.final.gtf > $out/2.identification/lncRNA.trans.gtf && touch 02getknownlncgtf.finished\n";
...
$mk2 .= "\tperl $conf{BIN}/gtf_to_lnclst.pl $out/2.identification/all.lncRNA.gtf | sort | uniq > $out/2.identification/all.final.lncgeneid.lst && touch 02getalllnclst.finished\n";
...
$mk3 .= "\tperl $conf{BIN}/get_sampleid.pl $out/3.filter/count.txt > $out/3.filter/count1.txt && touch 01getsampleid.finished\n";
$all3 .= "01getsampleid.finished ";

$mk3 .= "01counttofpkm.finished: 01getsampleid.finished\n";
$mk3 .= "\t$conf{Rscript} $conf{BIN}/count_to_fpkm.R && touch 01counttofpkm.finished\n";
...
$mk3 .= "\tperl $conf{BIN}/fishInWinter.pl $out/2.identification/all.final.lncgeneid.lst $out/3.filter/fpkm_result.txt | cat $out/3.filter/header.txt - > $out/3.filter/all.lncRNA.fpkm.txt && touch 02getalllncfpkm.finished\n";
$all3 .= "02getalllncfpkm.finished ";

$mk3 .= "02lncfilter.finished: 02getalllncfpkm.finished\n";
$mk3 .= "\tperl $conf{BIN}/new.filter_lncrna.pl $out/3.filter/all.lncRNA.fpkm.txt > $out/3.filter/all.lncRNA.filter.fpkm.txt && touch 02lncfilter.finished\n";
$all3 .= "02lncfilter.finished ";

$mk3 .= "03getpcglst.finished: 02lncfilter.finished\n";
$mk3 .= "\tless ../data/RefGene_anno | grep \"coding gene\" | cut -f 1 | sed \'s\/,\/\\n\/g\' | sort | uniq > $out/3.filter/refgene.codingene.lst && touch 03getpcglst.finished\n";
$all3 .=  "03getpcglst.finished ";

$mk3 .= "03getpcgfpkm.finished: 03getpcglst.finished\n";
$mk3 .= "\tperl $conf{BIN}/fishInWinter.pl $out/3.filter/refgene.codingene.lst $out/3.filter/fpkm_result.txt | cat $out/3.filter/header.txt - > $out/3.filter/pcg.fpkm.txt && touch 03getpcgfpkm.finished\n";
$all3 .=  "03getpcgfpkm.finished ";


$mk3 .= "03pcgfilterfpkm.finished: 03getpcgfpkm.finished\n";
$mk3 .= "\tperl $conf{BIN}/new.filter_lncrna.pl $out/3.filter/pcg.fpkm.txt > $out/3.filter/all.pcg.filter.fpkm.txt && touch 03pcgfilterfpkm.finished\n";
...
$mk4 .= "\tperl $conf{BIN}/get_average.pl $out/3.filter/all.lncRNA.filter.fpkm.txt > $out/4.ds_score/all.lncRNA.filter.avg.fpkm.txt && touch 01getlncavg.finished\n";
$all4 .= "01getlncavg.finished ";

$mk4 .= "01lncds.finished: 01getlncavg.finished\n";
$mk4 .= "\tperl $conf{BIN}/ds_score.pl $out/4.ds_score/all.lncRNA.filter.avg.fpkm.txt 2 n > $out/4.ds_score/all.lncRNA.filter.dsscore.txt && touch 01lncds.finished\n";
$all4 .= "01lncds.finished ";

$mk4 .= "02getpcgavg.finished: 01lncds.finished\n";
$mk4 .= "\tperl $conf{BIN}/get_average.pl $out/3.filter/all.pcg.filter.fpkm.txt > $out/4.ds_score/all.pcg.filter.avg.fpkm.txt  && touch 02getpcgavg.finished\n";
$all4 .= "02getpcgavg.finished ";

$mk4 .= "02pcgds.finished: 02getpcgavg.finished\n";
$mk4 .= "\tperl $conf{BIN}/ds_score.pl $out/4.ds_score/all.pcg.filter.avg.fpkm.txt 2 n > $out/4.ds_score/all.pcg.filter.dsscore.txt && touch 02pcgds.finished\n";
$all4 .= "02pcgds.finished ";

$mk4 .= "03getlncscore.finished: 02pcgds.finished\n";
$mk4 .= "\tperl $conf{BIN}/get_noncodingscore.pl $out/4.ds_score/all.lncRNA.filter.dsscore.txt > $out/4.ds_score/noncodingscore.txt && touch 03getlncscore.finished\n";
$all4 .= "03getlncscore.finished ";

$mk4 .= "03getpcgscore.finished: 03getlncscore.finished\n";
$mk4 .= "\tperl $conf{BIN}/get_codingscore.pl $out/4.ds_score/all.pcg.filter.dsscore.txt > $out/4.ds_score/codingscore.txt && touch 03getpcgscore.finished\n";
...
$mk4 .= "\t$conf{Rscript} $conf{BIN}/destiny.R && touch 03destiny.finished\n";
